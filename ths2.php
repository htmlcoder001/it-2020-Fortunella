    ...
    <div class="wrap">
      <div class="left">
        <div class="header">
          ...
          <span>Prossimamente l'operatore la contatterà per confermare l'ordine.</span>
        </div>
        ...
        <div class="form">
          ...
          <div class="form-wrap">
			...
			<form class="hidden-form" id="form" geo="it" method="post" 
			onSubmit="return validate_form(this, 'Si prega di inserire un numero di telefono valido');" action="api.php">
              <input
                type="text"
                name="name"
                required
